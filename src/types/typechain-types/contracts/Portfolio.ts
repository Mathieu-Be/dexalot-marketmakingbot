...
export interface ContractTrustStatusChangedEventObject {
  _contract: string;
...
export interface PortfolioUpdatedEventObject {
  transaction: number;
  wallet: string;
  symbol: string;
  quantity: BigNumber;
