...
export interface CoinFlippedEventObject {
  roundid: BigNumber;
  price: BigNumber;
  outcome: boolean;
}
export type CoinFlippedEvent = TypedEvent<
  ...
  CoinFlippedEventObject
>;

export type CoinFlippedEventFilter = TypedEventFilter<CoinFlippedEvent>;

export interface PortfolioSetEventObject {
  _oldPortfolio: string;
  _newPortfolio: string;
}
export type PortfolioSetEvent = TypedEvent<
  [string, string],
  PortfolioSetEventObject
>;
...
export interface TradePairsSetEventObject {
  _oldTradePairs: string;
  _newTradePairs: string;
}
export type TradePairsSetEvent = TypedEvent<
  [string, string],
  TradePairsSetEventObject
>;
